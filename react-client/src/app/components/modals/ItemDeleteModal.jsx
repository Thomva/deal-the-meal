...
const ItemDeleteModal = ({ classes = '', show, onConfirm, onDone }) => {
	...
	return (
		...
		<div className="modal__top modal__top--message">
			{currentStep === 0 && (
				<>
					<h1 className={classnames('modal__title modal__title--message', classes)}>Are you sure you want to delete this item?</h1>
					<div className="modal__subTitle modal__subTitle--message">This can't be undone</div>
				</>
			)}
			{currentStep === 1 && (
				<h1 className={classnames('modal__title modal__title--message', classes)}>Item deleted!</h1>
			)}
		</div>

...
class NoEmailMatchError extends AppError {
  public message: string = 'No user by that email';
  public name: string = 'User Not Found';
  public status: number = 401;
}

class InvalidPasswordError extends AppError {
  public message: string = 'Password is incorrect';
  public name: string = 'Invalid Password';
  public status: number = 401;
}
